...
pycbc_inference \
--config-file /home/kkacanja/ecc_gw190817/pe/gw230529/seob/0.3e_seob_sampling.ini \
--nprocesses 64 \
--processing-scheme mkl \
--output-file /home/kkacanja/ecc_gw190817/pe/gw230529/seob/result_seob_0.3e_sampling.hdf \
--seed 190814 \
--force \
--verbose 
