...
pycbc_inference \
--config-file /home/kkacanja/ecc_gw190817/pe/gw200105/teob/0.3ecc_teob_sampling.ini \
--nprocesses 64 \
--processing-scheme mkl \
--output-file /home/kkacanja/ecc_gw190817/pe/gw200105/teob/result_teob_0.3ecc_sampling.hdf \
--seed 190814 \
--force \
--verbose 
